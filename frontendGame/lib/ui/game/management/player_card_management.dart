...
void handleCardDrop(
  ...
  final enemyHitbox = Rect.fromLTWH(
    inimigoComponent.position.x - 50,
    inimigoComponent.position.y - 50,
    inimigoComponent.size.x + 100,
    inimigoComponent.size.y + 100,
  );
  ...
  if (enemyHitbox.contains(card.position.toOffset())) {
    ...
    if (cardIndex != -1) {
      ...
      final animatedCard = AnimatedCard(
        ...
        targetPosition: inimigoComponent.getCenterPosition(),
        cardIndex: cardIndex,
