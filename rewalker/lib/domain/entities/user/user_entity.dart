...
final class Usuario {
  ...
  factory Usuario.fromRemoteMap(Map<String, dynamic> map) {
    print('Usuario.fromRemoteMap - Map: $map');
    return _fromMap(
      userMap: map,
  ...
  factory Usuario.fromStorageMap(Map<String, dynamic> map) {
    print('Usuario.fromStorageMap - Map: $map');
    return _fromMap(
      userMap: map,
      avatarMap:
          map[kKeyAvatar] != null
  ...
  static Usuario _fromMap({
    ...
    if (avatarMap != null) {
      ...
      print('Usuario._fromMap - Avatar is a String: $avatarString');
      avatar = Avatar(id: avatarString, hp: 0, progressao: null, deck: []);
    } else {
      print('Usuario._fromMap - No avatar data provided');
    }
