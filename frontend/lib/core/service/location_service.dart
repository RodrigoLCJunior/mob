...
import 'package:midnight_never_end/core/library/constants.dart';
import 'package:midnight_never_end/domain/entities/core/location_entity.dart';
import 'package:midnight_never_end/domain/error/core/location_exception.dart';
...
final class LocationService implements ILocationService {
  ...
  @override
  Future<LocationEntity?> fetchCurrentLocation({
    int timeoutSeconds = LocationConstant.kTimeoutSeconds,
  }) async {
    try {
  ...
  Future<bool> requestPermission([bool openLocationSettings = true]) async {
    try {
      ...
      final List<LocationPermission> allowedAccess = [
