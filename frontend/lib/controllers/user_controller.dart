...
class UserManager {
  ...
  static Future<void> saveUser(User user) async {
    ...
    prefs.setString('user', jsonEncode(user.toJson())); // Converte para JSON e salva
  ...
  static Future<void> loadUser() async {
    ...
    if (userData != null) {
      currentUser = User.fromJson(jsonDecode(userData)); // Converte JSON para objeto
    }
  }
  ...
  // Atualizar apenas as moedas do usuário
  static Future<void> updateUserCoins(int newCoins) async {
    if (currentUser != null) {
      currentUser = currentUser!.copyWith(coins: newCoins);
