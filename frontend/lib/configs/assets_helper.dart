...
final class AssetsHelper {
  ...
  static final String assetsMapsUnselected =
      [_assetsMaps, 'marker_unselected.png'].joinPath;
  static final String assetsMapsSelected =
      [_assetsMaps, 'marker_selected.png'].joinPath;
